...
<form  class="layui-form"  method="post" enctype="multipart/form-data">
  <div class="layui-form-item" style="margin-top:15px;">
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="name" id="name" value="${customer.name}"  lay-verify="required" autocomplete="off" class="layui-input" />
	    </div>
	</div>
	<div class="layui-inline">
  ...
  <div class="layui-form-item" style="margin-top:15px;">
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="phone" id="phone"  value="${customer.phone}"  lay-verify="required" autocomplete="off" class="layui-input" />
	    </div>
	</div>
	<div class="layui-inline">
	    <label class="layui-form-label">邮箱</label>
	    <div class="layui-input-inline">
	      <input type="text" name="email" id="email"  value="${customer.email}"  lay-verify="required"  autocomplete="off" class="layui-input" />
	    </div>
	</div>
  </div>
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      ...
      <textarea name="address" id="address" rows="5" cols="10" placeholder="详细地址" class="layui-textarea">${customer.address}</textarea>
    </div>
   <div class="layui-form-item" style="margin-top:15px;">
		<div class="layui-inline">
		    <label class="layui-form-label">微信账号</label>
		    <div class="layui-input-inline">
		      <input type="text" name="wechat"   id="wechat" value="${customer.wechat}" lay-verify="required" autocomplete="off" class="layui-input" />
		    </div>
		</div>
		<div class="layui-inline">
		    <label class="layui-form-label">微信昵称</label>
		    <div class="layui-input-inline">
		      <input type="text" name="wechatNetname" id="wechatNetname" value="${customer.wechatNetname}" lay-verify="required"  autocomplete="off" class="layui-input" />
		    </div>
		</div>
  </div>
     ...
     <div class="layui-form-item" style="margin-top:15px;">
		<div class="layui-inline">
		    ...
		    <div class="layui-input-inline">
		      <input type="text" name="qq" id="qq" value="${customer.qq}" lay-verify="required" autocomplete="off" class="layui-input" />
		    </div>
		</div>
		<div class="layui-inline">
		    <label class="layui-form-label">QQ昵称</label>
		    <div class="layui-input-inline">
		      <input type="text" name="qqNetname" id="qqNetname" value="${customer.qqNetname}" lay-verify="required"  autocomplete="off" class="layui-input" />
		    </div>
		</div>
  </div>
  ...
  <div class="layui-form-item" style="margin-top:15px;">
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input style="width:100px;" placeholder="单位：CM" value="${customer.height}" type="text" name="height" id="height" lay-verify="required" autocomplete="off" class="layui-input" />
	...
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" style="width:100px;" placeholder="单位：KG" value="${customer.weight}" name="weight" id="weight" lay-verify="required"  autocomplete="off" class="layui-input" />
	    </div>
	</div>
  </div>
  ...
  <div class="layui-form-item" style="margin-top:15px;">
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="hobby" id="hobby" value="${customer.hobby}" lay-verify="required" autocomplete="off" class="layui-input" />
	    </div>
	</div>
	<div class="layui-inline">
	...
	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="cardId" id="cardId" value="${customer.cardId}" lay-verify="required"  autocomplete="off" class="layui-input" />
	    </div>
	</div>
  </div>
<div class="layui-form-item" style="margin-top:15px;">
		 	<div class="layui-inline">
			    ...
			    <div class="layui-input-inline">
			      <input type="text" name="recommender" id="recommender"  value="${customer.recommender}"  autocomplete="off" class="layui-input" />
			    </div>
			</div>
			<div class="layui-inline">
			    <label class="layui-form-label">信仰</label>
			    <div class="layui-input-inline">
			      <input type="text" name="believer" id="believer"  value="${customer.believer}"  autocomplete="off" class="layui-input" />
			    </div>
			</div>
	 </div>
	  ...
	  <div class="layui-form-item" style="margin-top:15px;">
	  		<div class="layui-inline">
			    ...
			    <div class="layui-input-inline">
			      <input type="text" name="urgentName" id="urgentName"   value="${customer.urgentName}" autocomplete="off" class="layui-input" />
			    </div>
			</div>
			<div class="layui-inline">
			    <label class="layui-form-label">紧急电话</label>
			    <div class="layui-input-inline">
			      <input type="text" name="urgentPhone" id="urgentPhone"   value="${customer.urgentPhone}" autocomplete="off" class="layui-input" />
			    </div>
			</div>
			<div class="layui-inline">
	...
	<input type="hidden" name="pic" id="pic" value="${customer.pic}">
	  ...
	  <!-- <button type="button" class="layui-btn" id="test9">开始上传</button> -->
		<div class="layui-upload-list" style="margin-left:110px">
		    <c:choose>
       		...
       		<c:when test="${(!empty customer.pic)}">
          		<img class="layui-upload-img" id="demo1" width="100" height="100" src="/ws/${customer.pic}">
          	</c:when>
          	<c:otherwise>
	...
	layui.use(['form','layer'], function(){
			 ...
			 //当前容器的全部表单字段，名值对形式：{name: value}
			  ...
			  $.ajax({
					...
					success:function(data){
						if(data>0){
							  return layer.msg('修改用户成功！');
						}else{
							 return layer.msg('修改用户失败，请联系管理员！');
						}
					}
				});
	  ...
	  //监听下拉框时间
		...
		function initAddress(){
			var dProvince="${customer.province}";
			var dCity="${customer.city}";
			var dArea="${customer.area}";
