...
<div class="zhuyi">修改订单信息中的选项（一个或者多个），必须要点击[确认修改]案例，来保存您修改的信息</div>
<form  class="layui-form layui-form-pane"  method="post" enctype="multipart/form-data">
  <div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
    ...
    <div class="layui-input-inline">
      <input type="text" width="800px" name="ordernumber" id="ordernumber" value="${order.ordernumber}"  autocomplete="off" class="layui-input number" disabled="disabled"/>
    </div>
  </div> 
  <div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
    ...
    <div class="layui-input-inline">
        <input type="text"  name="orderconsignee" id="orderconsignee"  value="${order.orderconsignee}"   lay-verify="required"  autocomplete="off" class="layui-input " />
    </div>
      <label class="layui-form-label">联系电话 </label>
    <div class="layui-input-inline">
        <input type="text"  name="phone" id="consigneePhone" value="${order.phone}" lay-verify="required"  autocomplete="off" class="layui-input " />
    </div>
  </div>
	 ...
	 <div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
	    ...
	    <div class="layui-input-inline">
	        <input type="text"  name="address" id="address" lay-verify="required"   value="${order.address}"  autocomplete="off" class="layui-input address" />
	    </div>
	  ...
	  <div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
	    ...
	    <div class="layui-input-inline">
	        <input style="color:red" type="text"  name="productamounttotal" value="${order.productamounttotal}" id="productMoney"   disabled="disabled"   autocomplete="off" class="layui-input " />
	    </div>
	    <label class="layui-form-label" >实际付款 </label>
	    <div class="layui-input-inline">
	        <input style="color:red" type="text"  name="orderamounttotal" id="orderMoney"    value="${order.orderamounttotal}" autocomplete="off" class="layui-input " />
	    </div>
	  </div>
	 <div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
	     <label class="layui-form-label" >快递单号</label>
	    <div class="layui-input-inline">
	        <input  type="text"  name="orderlogisticsid" id="orderlogisticsId"  value="${order.orderlogisticsid}"  autocomplete="off" class="layui-input " />
	    </div>
	    <label class="layui-form-label" >发货时间 </label>
	    <div class="layui-input-inline">
	       
	     <input type="text" class="layui-input" name="deliverytime" id="deliveryTime" value="" readonly="" placeholder="yyyy-MM-dd">
	    </div>
	  </div>
	<div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" class="layui-input" name="paymenttime" id="paymentTime" value="${order.paymenttime}"  readonly="" placeholder="yyyy-MM-dd">
	    </div>
	  </div>
	<div class="layui-form-item" style="margin-top:15px;margin-left:15px;">
	     <label class="layui-form-label" >订单备注</label>
	    <div class="layui-input-inline">
	     <textarea name="orderremark" id="orderRemark" rows="5" cols="10" placeholder="订单备注信息" class="layui-textarea">${order.orderremark}</textarea>
	    </div>
	  </div>
 		<!-- 添加成功后，把订单的ID保存在此 -->
...
<!-- 注意：如果你直接复制所有代码到本地，上述js路径需要改成你本地的 --> 
 <script type="text/javascript">
	...
	layui.use(['table','util','form','rate','laydate'], function(){
	  ...
	  //设置时间
	  var paymenttime= layui.util.toDateString("${order.paymenttime}");
	  paymenttime=paymenttime.substring(0,10);
	 
	  
	  var deliverytime= layui.util.toDateString("${order.deliverytime}");
