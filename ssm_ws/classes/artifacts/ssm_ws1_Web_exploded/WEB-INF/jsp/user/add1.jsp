...
<form  class="layui-form"  method="post" enctype="multipart/form-data">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="checkbox" checked="" name="state" lay-skin="switch" lay-filter="status" lay-filter="switchTest" lay-text="启用|停用">
    </div>
  </div>
<div class="layui-upload">
	<input type="hidden" id="pic" name="pic">
  <button type="button" class="layui-btn" id="image">图像上传</button> 
