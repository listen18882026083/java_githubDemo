        ...
        <form class="layui-form"  method="post" action="${pageContext.request.contextPath}/user/login3.action">
            ...
            <div>
                <input type="text" name="code"
                       ...
                       autocomplete="off"
                       class="layui-input admin-input admin-input-verify">
                <img class="admin-captcha codeimg" id="codeimg" src="${pageContext.request.contextPath}/admin/code.action"
...
<script>
	...
	function login(){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/login/login3.action",
			type:"POST",
